...
namespace MovieAPI.Controllers
{
    ...
    {
        private readonly IMongoRepositories<Movie> _movieRepository;
        private readonly ISyncService<Movie> _movieSyncService;
        public MovieController(IMongoRepositories<Movie> movieRepository,
        ...
        {
            var resutlt = _movieRepository.GetRecordById(id);
        ...
        public IActionResult Delete(Guid id)
        {
            ...
            if(movie == null)
            {
                return BadRequest("Movie doesn't exits");
            }
